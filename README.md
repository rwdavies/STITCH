...
1. Add reference_shuffleHaplotypeIterations
...
cd releases
wget https://github.com/rwdavies/stitch/releases/download/1.5.6/STITCH_1.5.6.tar.gz ## or curl -O
R CMD INSTALL STITCH_1.5.6.tar.gz
```
