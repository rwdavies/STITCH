...
1. Fix bugs relating to installation
...
cd releases
wget https://github.com/rwdavies/stitch/releases/download/1.6.7/STITCH_1.6.7.tar.gz ## or curl -O
R CMD INSTALL STITCH_1.6.7.tar.gz
```
